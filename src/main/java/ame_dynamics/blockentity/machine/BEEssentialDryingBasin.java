...
public class BEEssentialDryingBasin extends BlockEntityProgressMachine<RecipeMechanicalDryingBasin>
    ...
    public BEEssentialDryingBasin(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
    ...
    protected IFluidTankHolder getInitialFluidTanks(IContentsListener listener,
        ...
        builder.addTank(
                inputTank = BasicFluidTank.input(100000,
                        stack -> containsInputFluidItem(inputSlot.getStack(), stack),
                        this::containsInputFluid,
                        recipeCacheListener));
    ...
    @Override
    public void onCachedRecipeChanged(ICachedRecipe<RecipeMechanicalDryingBasin> cachedRecipe, int cacheIndex) {
