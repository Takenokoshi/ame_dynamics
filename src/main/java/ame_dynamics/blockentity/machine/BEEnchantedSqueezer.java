...
public class BEEnchantedSqueezer extends BlockEntityRecipeMachine<RecipeMechanicalSqueezer> implements IAMEDSqueezer {
    ...
    private MachineEnergyContainer<BEEnchantedSqueezer> energyContainer;
    ...
    public BEEnchantedSqueezer(IBlockProvider blockProvider, BlockPos pos, BlockState state) {
